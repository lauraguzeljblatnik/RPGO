...
%Argyrisova interpolacijska shema
...
% Vrednosti polinoma v domenskih tockah za N = 10 (prva dva stolpca sta kartezicni koordinati domenske tocke, tretji pa vrednost polinoma):
...
for n1=10:-1:0
    for n2=0:10-n1
        n3 = 10-n1-n2;
        V = T(1,:)*n1/10+T(2,:)*n2/10+T(3,:)*n3/10;
        t1(i,1:2) = V;
        t1(i,3) = f(V(1), V(2));
        i = i+1;
    end
...
i
t1
%Maksimalna absolutna napaka aproksimacije funkcije f v domenskih tockah
%trikotnika T za N = 50:
   % 0.1256640319
[X,Y,Z] = peaks(50);
