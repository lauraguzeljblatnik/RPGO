...
% Opis :
% lsqbezier2 vrne kontrolne točke tenzorskega polinoma , ki
% po metodi najmanjših kvadratov najbolje aproksimira dane
% podatke
%
% Definicija :
% B = lsqbezier2 (m,n,P)
...
% koeficiente polinoma , ki po metodi najmanjših
