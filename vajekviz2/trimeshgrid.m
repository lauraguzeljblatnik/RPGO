...
% Opis :
% trimeshhgrid sestavi triangulacijo trikotnika z oglišči
% (0 ,0) , (1 ,0) , (0 ,1) in izračuna točke triangulacije v
% obliki baricentričnih koordinat
%
% Definicija :
% [TRI ,U] = trimeshgrid (d)
%
...
% vrstica predstavlja baricentrične koordinate ene
% točke triangulacije
TRI = zeros ( d ^2 ,3) ;
U = zeros (( d +1) *( d +2) /2 ,3) ;
k = 1;
